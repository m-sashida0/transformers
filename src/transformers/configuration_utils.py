...
class PretrainedConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.fix_temperature = kwargs.pop("fix_temperature", None)
    @property
    ...
    def from_dict(cls, config_dict: dict[str, Any], **kwargs) -> "PretrainedConfig":
        ...
        config_dict["fix_layer"] = kwargs.pop("fix_layer", None)
        config_dict["fix_head"] = kwargs.pop("fix_head", None)
        config_dict["fix_temperature"] = kwargs.pop("fix_temperature", None)
